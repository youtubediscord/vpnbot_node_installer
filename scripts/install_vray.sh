...
XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_TOTAL="${XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_TOTAL:-150}"
XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_BAD="${XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_BAD:-25}"
XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_ESTAB="${XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_ESTAB:-700}"
