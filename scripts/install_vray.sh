...
XRAY_CONN_GUARD_PORT_TOTAL_STATES="${XRAY_CONN_GUARD_PORT_TOTAL_STATES:-6000}"
XRAY_CONN_GUARD_PORT_BAD_STATES="${XRAY_CONN_GUARD_PORT_BAD_STATES:-1200}"
XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_TOTAL="${XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_TOTAL:-500}"
XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_BAD="${XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_BAD:-100}"
XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_ESTAB="${XRAY_CONN_GUARD_PORT_PRESSURE_MIN_IP_ESTAB:-900}"
XRAY_CONN_GUARD_PORT_PRESSURE_MAX_BANS_PER_PORT="${XRAY_CONN_GUARD_PORT_PRESSURE_MAX_BANS_PER_PORT:-5}"
...
VPNBOT_XRAY_RU_EGRESS_ALLOW_DOMAINS="${VPNBOT_XRAY_RU_EGRESS_ALLOW_DOMAINS:-domain:pally.info,domain:pal24.pro,domain:majestic-rp.ru,domain:majestic-launcher.ru,domain:majestic-files.net,domain:majestic-files.com,domain:gta5majestic.com}"
